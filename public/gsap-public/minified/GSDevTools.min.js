...
!(function (e, t) {
  ...
  var g,
    ...
    N = function _placeSiblings(e, t) {
      ...
      if (e === f) return e;
      if ((d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), (o = l ? m : h), l))
        (c
          ? ((r =
              -(i = (function _getCTM(e) {
                ...
                return (
                  o ||
                    ...
                    t
                      ? (e.style[b] = t)
                      : e.style.removeProperty(b.replace(/([A-Z])/g, '-$1').toLowerCase())),
                  o || v.clone()
                );
              })(e)).e / i.a),
            (a = -i.f / i.d),
        ...
        if ('absolute' !== (s = f.getComputedStyle(e)).position && 'fixed' !== s.position)
  ...
  function Ka(e, t) {
    ...
    return Math.max(
      0,
      Ze(e) ? Math.max(ye[n], s[n]) - (ve['inner' + o] || ye[i] || s[i]) : e[n] - e[i]
    );
  }
  function La(e, t) {
    var o = Ka(e, 'x'),
  ...
  function Pa(e) {
    if (e === ve)
      return (
        (p.left = p.top = 0),
        (p.width = p.right = ye.clientWidth || e.innerWidth || s.clientWidth || 0),
        (p.height = p.bottom =
  ...
  function Va(e) {
    ...
    return (
      ...
      (!(
        ...
        ('false' === t ||
          (!n.test(e.nodeName + '') && 'true' !== e.getAttribute('contentEditable')))
      ) ||
        Va(e.parentNode))
    );
  }
  ...
  function _a(e) {
    if (X() && document.body) {
      ...
      ((ve = window),
        ...
        (Ce = 'grab' === be.style.cursor ? 'grab' : 'move'),
            ...
            : (e.viewBox &&
              ...
              u ||
                ...
                (u =
                  ...
                  (p ? 0 : parseFloat(f.borderLeftWidth) + parseFloat(f.borderRightWidth))),
                (g =
                  (parseFloat(f.height) || e.clientHeight || 0) +
                  (p ? 0 : parseFloat(f.borderTopWidth) + parseFloat(f.borderBottomWidth))))),
          (n = u),
          (r = g));
      }
      return e === t
  ...
  function Draggable(g, p) {
      ...
      if (j.autoScroll && j.isDragging && (te || L)) {
        ...
        for (
          te = !1,
            ...
            r = j.pointerY - Ge.scrollTop;
          c && !o;

        )
          ((t = (o = Ze(c.parentNode)) ? Ge : c.parentNode),
            (n = o
              ? {
              ...
              ((l = t._gsMaxScrollY - t.scrollTop) < 0
                ...
                : r > n.bottom - ie && l
                  ...
                  : r < n.top + oe &&
                    t.scrollTop &&
                    ((te = !0),
                    (s = -Math.min(t.scrollTop, (d * (1 - Math.max(0, r - n.top) / oe)) | 0))),
              s && (t.scrollTop += s)),
            U &&
              ((l = t._gsMaxScrollX - t.scrollLeft) < 0
                ...
                : i > n.right - ne && l
                  ...
                  : i < n.left + re &&
                    t.scrollLeft &&
                    ((te = !0),
                    (a = -Math.min(t.scrollLeft, (d * (1 - Math.max(0, i - n.left) / re)) | 0))),
              a && (t.scrollLeft += a)),
            o &&
              (a || s) &&
              (ve.scrollTo(t.scrollLeft, t.scrollTop), ge(j.pointerX + a, j.pointerY + s)),
            (c = t));
      }
      if (L) {
        var p = j.x,
        ...
        (W
          ...
          : f
            ? (K && ((j.deltaY = u - f.top()), f.top(u)),
              U && ((j.deltaX = p - f.left()), f.left(p)))
            : G
              ? (K && ((j.deltaY = u - parseFloat(le.y)), (le.y = u + 'px')),
                U && ((j.deltaX = p - parseFloat(le.x)), (le.x = p + 'px')),
                le.renderTransform(1, le))
              : (K && ((j.deltaY = u - parseFloat(g.style.top || 0)), (g.style.top = u + 'px')),
                U && ((j.deltaX = p - parseFloat(g.style.left || 0)), (g.style.left = p + 'px'))),
          !h ||
            e ||
            O ||
            (!(O = !0) === Qa(j, 'drag', 'onDrag') &&
              (U && (j.x -= j.deltaX), K && (j.y -= j.deltaY), ui(!0)),
            (O = !1)));
      }
      L = !1;
    }
      ...
      (g._gsap || (le = me.core.getCache(g)),
        ...
        (N || R || A) &&
          ...
          (A &&
            ((ze.x = j.x),
            (ze.y = j.y),
            (o = A(ze)).x !== j.x && ((j.x = o.x), (L = !0)),
            o.y !== j.y && ((j.y = o.y), (L = !0))),
          N && (o = N(j.x)) !== j.x && ((j.x = o), W && (j.rotation = o), (L = !0)),
          R && ((o = R(j.y)) !== j.y && (j.y = o), (L = !0))),
        L && ui(!0),
        e || ((j.deltaX = j.x - i), (j.deltaY = j.y - r), Qa(j, 'throwupdate', 'onThrowUpdate')));
    }
    function wi(a, s, l, o) {
      return (
        null == s && (s = -Be),
          ...
          : p.bounds &&
            ...
            W
              ...
              : _(p.bounds.maxX) && _(p.bounds.maxY)
                ? ((t = Ra(g, g.parentNode)),
                  (j.minX = S = Math.round(Mh(V, 'px') + e.left - t.left)),
                  (j.minY = E = Math.round(Mh(Q, 'px') + e.top - t.top)),
                  (j.maxX = k = Math.round(S + (e.width - t.width))),
                  (j.maxY = C = Math.round(E + (e.height - t.height))))
                : ((e = p.bounds),
                  (j.minX = S = e.minX),
                  (j.minY = E = e.minY),
                  (j.maxX = k = e.maxX),
                  (j.maxY = C = e.maxY)),
            k < S && ((j.minX = k), (j.maxX = k = S), (S = j.minX)),
            C < E && ((j.minY = C), (j.maxY = C = E), (E = j.minY)),
            W && ((j.minRotation = S), (j.maxRotation = k)),
            (D = !0)),
        p.liveSnap &&
          ((o = !0 === p.liveSnap ? p.snap || {} : p.liveSnap),
          (n = Ae(o) || Z(o)),
          W
            ? ((N = wi(n ? o : o.rotation, S, k, 1)), (R = null))
            : o.points
              ? (A = (function buildPointSnapFunc(l, s, c, d, p, u, g) {
                  return (
                    (u = u && u < Be ? u * u : Be),
                    Z(l)
                      ? function (e) {
                      ...
                      : Ae(l)
                        ? function (e) {
                            for (var t, o, n, i, r = l.length, a = 0, s = Be; -1 < --r; )
                ...
                })(n ? o : o.points, S, k, E, C, o.radius, f ? -1 : 1))
              : (U && (N = wi(n ? o : o.x || o.left || o.scrollLeft, S, k, f ? -1 : 1)),
                K && (R = wi(n ? o : o.y || o.top || o.scrollTop, E, C, f ? -1 : 1)))));
    }
    function zi() {
    ...
    function Bi(e, t) {
      ...
      e && Se
        ? (!0 === e &&
            ...
            W
              ? (e.rotation = Ua(j, n ? o : o.rotation, k, S, 1, t))
              : (U &&
                  (e[V] = Ua(
                    j,
    ...
    function Ci(e) {
      ...
      ((X = getGlobalMatrix(g.parentNode, !0)),
        e &&
          j.isPressed &&
          !X.equals(o || new he()) &&
          ((t = o.inverse().apply({ x: b, y: w })), X.apply(t, t), (b = t.x), (w = t.y)),
        X.equals(i) && (X = null));
    }
    function Di() {
      var e,
        ...
        i = ce ? Ga(de) : 0,
        r = ce ? Fa(de) : 0;
      (G && ((le.x = Mh(V, 'px') + 'px'), (le.y = Mh(Q, 'px') + 'px'), le.renderTransform()),
        Ci(!1),
        (We.x = j.pointerX - i),
        (We.y = j.pointerY - r),
        X && X.apply(We, We),
        (b = We.x),
        (w = We.y),
        L && (ge(j.pointerX, j.pointerY), ui(!0)),
        (d = getGlobalMatrix(g)),
        f
          ? (yi(), (M = f.top()), (T = f.left()))
          : (pe() ? (vi(!0, !0), yi()) : j.applyBounds(),
            W
              ? ((e = g.ownerSVGElement
                ...
                (o = P.y - j.pointerY + r),
                (T = j.x),
                (M = j.y = Math.atan2(o, t) * Xe))
              : ((M = Mh(Q, 'px')), (T = Mh(V, 'px')))),
        D &&
          n &&
          (k < T ? (T = k + (T - k) / n) : T < S && (T = S - (S - T) / n),
          W || (C < M ? (M = C + (M - C) / n) : M < E && (M = E - (E - M) / n))),
        (j.startX = T = da(T)),
        (j.startY = M = da(M)));
    }
    function Fi() {
    ...
    function Gi(e, t) {
      ...
      if (
        ...
        if (
          ...
          (j.pointerEvent = e),
          Me[e.type]
            ? ((y = ~e.type.indexOf('touch') ? e.currentTarget || e.target : de),
              za(y, 'touchend', fe),
              za(y, 'touchmove', ue),
              za(y, 'touchcancel', fe),
              za(de, 'touchstart', Ea))
          ...
          (H = null),
          (Ee && y) || (za(de, 'mouseup', fe), e && e.target && za(e.target, 'mouseup', fe)),
          (x = ae.call(j, e.target) && !1 === p.dragClickables && !t))
        )
          return (
        ...
        if (
          ...
          (F = !Y && !j.allowEventDefault) && (Ba(e), za(ve, 'touchforcechange', Ba)),
          e.changedTouches
          ...
          Qa(j, 'pressInit', 'onPressInit'),
          (Y || j.autoScroll) && La(g.parentNode),
          !g.parentNode ||
            !j.autoScroll ||
            f ||
            W ||
    ...
    function Ki(e) {
      if (e && j.isDragging && !f) {
        ...
        (o || n) &&
          (X ? ((b -= o * X.a + n * X.c), (w -= n * X.d + o * X.b)) : ((b -= o), (w -= n)),
          (t._gsScrollX += o),
          (t._gsScrollY += n),
    ...
    function Li(e) {
      ...
      ((j.isPressed || n || o) && ((s && e.detail && o && !r) || Ba(e)),
        o || n || z || (e && e.target && (j.pointerEvent = e), Qa(j, 'click', 'onClick')));
    }
    function Mi(e) {
      return X
    ...
    var u,
      ...
      ue = function onMove(e) {
        ...
        if (u && !De && j.isPressed && e) {
          ...
          Y &&
          !H &&
          ((We.x = e.pageX - (ce ? Ga(de) : 0)),
          (We.y = e.pageY - (ce ? Fa(de) : 0)),
          X && X.apply(We, We),
          (o = We.x),
          (n = We.y),
          (((r = Math.abs(o - b)) !== (a = Math.abs(n - w)) && (q < r || q < a)) ||
            (ke && Y === H)) &&
            ((H = a < r && U ? 'x' : 'y'),
            Y && H !== Y && za(ve, 'touchforcechange', Ba),
            !1 !== j.vars.lockAxisOnTouchScroll &&
              U &&
              K &&
              ((j.lockedAxis = 'x' === H ? 'y' : 'x'),
              Z(j.vars.onLockAxis) && j.vars.onLockAxis.call(j, s)),
            ke && Y === H))
            ? fe(s)
            : ((F =
                j.allowEventDefault || (Y && (!H || Y === H)) || !1 === s.cancelable
                  ? F && !1
                  : (Ba(s), !0)),
              j.autoScroll && (te = !0),
      ...
      ge = function setPointerPosition(e, t, o) {
        ...
        ((j.pointerX = e),
          ...
          ce && ((e -= Ga(de)), (t -= Fa(de))),
          W
            ? ((a = Math.atan2(P.y - t, e - P.x) * Xe),
              180 < (s = j.y - a) ? ((M -= 360), (j.y = a)) : s < -180 && ((M += 360), (j.y = a)),
              (r =
                j.x !== T || Math.max(Math.abs(b - e), Math.abs(w - t)) > q
                  ? ((j.y = a), T + (M - a) * c)
                  : T))
            : (X && ((l = e * X.a + t * X.c + X.e), (t = e * X.b + t * X.d + X.f), (e = l)),
              (i = t - w) < q && -q < i && (i = 0),
              (n = e - b) < q && -q < n && (n = 0),
              (j.lockAxis || j.lockedAxis) &&
                (n || i) &&
                ((l = j.lockedAxis) ||
                  ((j.lockedAxis = l = U && Math.abs(n) > Math.abs(i) ? 'y' : K ? 'x' : null),
                  l && Z(j.vars.onLockAxis) && j.vars.onLockAxis.call(j, j.pointerEvent)),
                'y' === l ? (i = 0) : 'x' === l && (n = 0)),
              (r = da(T + n * c)),
              (a = da(M + i * c))),
          (N || R || A) &&
            (j.x !== r || (j.y !== a && !W)) &&
            (A && ((ze.x = r), (ze.y = a), (l = A(ze)), (r = da(l.x)), (a = da(l.y))),
            N && (r = da(N(r))),
            R && (a = da(R(a)))),
          D &&
            (k < r ? (r = k + Math.round((r - k) * d)) : r < S && (r = S + Math.round((r - S) * d)),
            W ||
              (C < a
                ? (a = Math.round(C + (a - C) * d))
                : a < E && (a = Math.round(E + (a - E) * d)))),
          (j.x === r && (j.y === a || W)) ||
            (W
              ? ((j.endRotation = j.x = j.endX = r), (L = !0))
              : (K && ((j.y = j.endY = a), (L = !0)), U && ((j.x = j.endX = r), (L = !0))),
            o && !1 === Qa(j, 'move', 'onMove')
              ...
              : !j.isDragging &&
                j.isPressed &&
                ((j.isDragging = z = !0), Qa(j, 'dragstart', 'onDragStart'))));
      },
      fe = function onRelease(e, t) {
        if (
          ...
          if (
            ...
            (Ee && y) ||
              (Aa(de, 'mouseup', onRelease), e && e.target && Aa(e.target, 'mouseup', onRelease)),
            (L = !1),
            l && ((ee = Fe = Ye()), (j.isDragging = !1)),
            xa(ui),
            x && !c)
          )
            return (
          ...
          for (n = J.length; -1 < --n; )
            Ma(J[n], 'cursor', p.cursor || (!1 !== p.cursor ? Ce : null));
          if ((Ne--, e)) {
          ...
          return (
            c && s
              ? (Ba(s), (F = !0), Qa(j, 'release', 'onRelease'))
              : s && !l
                ? ((F = !1),
                  ...
                  (ke && 'touchmove' === s.type) ||
                    ...
                    (Qa(j, 'click', 'onClick'),
                    Ye() - se < 300 && Qa(j, 'doubleclick', 'onDoubleClick'),
                    (r = s.target || g),
                    (se = Ye()),
                    ...
                    ke || s.defaultPrevented || me.delayedCall(0.05, a)))
                : (Bi(p.inertia || p.throwProps),
                  j.allowEventDefault ||
                  !s ||
                  (!1 === p.dragClickables && ae.call(j, s.target)) ||
                  !l ||
                  (Y && (!H || Y !== H)) ||
                  !1 === s.cancelable
                    ? (F = !1)
    ...
    return (
      ...
      (e.startDrag = function (e, t) {
        ...
        (Gi(e || j.pointerEvent, !0),
          t &&
            ...
            (b -= i.x - r.x),
            (w -= i.y - r.y)),
          j.isDragging || ((j.isDragging = z = !0), Qa(j, 'dragstart', 'onDragStart')));
      }),
      (e.drag = ue),
      ...
      (e.getDirection = function (e, t) {
        ...
        return (
          'element' === l && ((a = Pa(j.target)), (s = Pa(e))),
          (o =
            'start' === l
              ? j.x - T
              : 'velocity' === l
          ...
          if (
            ...
            for (
              ...
              ((a = (s = Ze(r.parentNode)) ? Ge : r.parentNode),
                K && a.scrollTop > a._gsMaxScrollY && (a.scrollTop = a._gsMaxScrollY),
                U && a.scrollLeft > a._gsMaxScrollX && (a.scrollLeft = a._gsMaxScrollX),
                (r = a));
          j.isThrowing &&
            (i || j.endX > k || j.endX < S || j.endY > C || j.endY < E) &&
      ...
      (e.update = function (e, t, o) {
        ...
        return (
          Ci(!t),
          e ? j.applyBounds() : (L && o && ui(!0), vi(!0)),
          t && (ge(j.pointerX, j.pointerY), L && ui(!0)),
          j.isPressed &&
            !t &&
            ((U && 0.01 < Math.abs(a - j.x)) || (K && 0.01 < Math.abs(s - j.y) && !W)) &&
            Di(),
          j.autoScroll &&
            (La(g.parentNode, j.isDragging), (te = j.isDragging), ui(!0), Ia(g, Ki), Ha(g, Ki)),
          j
        );
      }),
      (e.enable = function (e) {
        var t,
          ...
          i = { lazy: !0 };
        if (
          (!1 !== p.cursor && (i.cursor = p.cursor || Ce),
        ...
        return (
          Ha(g, Ki),
          (u = !0),
          Se && 'soft' !== e && Se.track(f || g, G ? 'x,y' : W ? 'rotation' : 'top,left'),
        ...
        if ('soft' !== e) {
          for (ta(J, null), n = J.length; -1 < --n; )
            ((t = J[n]),
              ...
              Aa(t, 'contextmenu', ti));
          (Wa(J, !0),
            y && (Aa(y, 'touchcancel', fe), Aa(y, 'touchend', fe), Aa(y, 'touchmove', ue)),
            Aa(de, 'mouseup', fe),
            Aa(de, 'mousemove', ue));
        }
        return (
          ...
          Se &&
            'soft' !== e &&
            (Se.untrack(f || g, G ? 'x,y' : W ? 'rotation' : 'top,left'),
            j.tween && j.tween.kill()),
          f && f.disable(),
          xa(ui),
  ...
  function Eb(e, t, o) {
    ...
    return (
      ...
      'svg' === e && (n.setAttribute('xmlns', z), n.setAttribute('xmlns:xlink', G)),
      o && (n.style.cssText = o),
      n
    );
  }
  ...
  function Nb(t, e, o, n) {
    ...
    if (
      ...
      'mousedown' === e &&
        (r = xb(t.onpointerdown) ? (xb(t.ontouchstart) ? null : 'touchstart') : 'pointerdown'))
    )
      return (
    ...
    ((V = e || tb()),
      Q ||
        (V &&
          ...
          (j = V.core.Animation),
          (oe = V.timeline({ data: 'indy', autoRemoveChildren: !0, smoothChildTiming: !0 })).kill(),
          (oe._dp = 0),
          oe.to({}, { duration: 1e12 }),
          (q = V.timeline(
            {
          ...
          ne(2, function () {
            var e, t, o;
            if (!ee)
              for (Rb(), e = q._first, o = q._start; e; )
                ((t = e._next),
    ...
    ue = function GSDevTools(r) {
      ...
      function Ho(c, d, p) {
        return function (e) {
          ...
          (p &&
            ...
            c !== D && (t = D.getBoundingClientRect()).left && (s -= o.left + o.width - t.left)),
            (m = P),
      ...
      function No(e) {
        if (!X.isPressed) {
          ...
          if (o < k)
            return ((k = o = Math.max(0, o)), (M.style.left = k + '%'), void B.startDrag(e));
          if (S < o)
            return ((S = o = Math.min(100, o)), (D.style.left = S + '%'), void Y.startDrag(e));
      ...
      function So(e) {
        if (($n('loop', (d = e)), d)) {
          if ((N.play(), v.progress() >= S / 100)) {
            ...
            (t === i && t.seek(s + ((l - s) * k) / 100),
              i._repeat && !k && 100 === S ? v.totalProgress(0, !0) : v.progress(k / 100, !0),
              O());
          }
        } else N.reverse();
      }
      ...
      function Uo() {
        ...
        for (
          ...
          (((e = n[t] || Eb('option', C)).animation = o[t]),
      ...
      function Vo(e) {
        ...
        if (
          ...
          if (
            (i && ((i._inProgress = k), (i._outProgress = S)),
            (i = e),
            ...
            (M.style.left = k + '%'),
            (D.style.left = S + '%'),
            c && ($n('animation', i.vars.id), $n('in', k), $n('out', S)),
            (s = 0),
            ...
            if (
              (ee === p && (ee = null), (s = Math.min(k * i.duration(), i.time())), i !== a && a)
            ) {
              for (
              ...
              (o < l - s && (l = s + o),
                ...
                (v = V.to(
                  a,
                  { duration: l - s, time: l, ease: 'none', data: 'root', parent: oe },
                  oe._time
                )));
      ...
      function Xo(e) {
        (Vo(C.options[C.selectedIndex].animation),
      ...
      function Yo() {
        ...
        (v.timeScale(t),
          ...
          P ||
            (v.progress() >= S / 100
              ? ((e = v._targets && v._targets[0]) === i && e.seek(s + ((l - s) * k) / 100),
                v.progress(k / 100, !0).pause())
              : v.pause(),
            ne(0.01, function () {
              return v.resume();
            })),
      ...
      function ep(e) {
        ...
        (t && ((t._inProgress = _n('in') || 0), (t._outProgress = _n('out') || 100)),
          r.paused && I(),
          (i = null),
          Vo(a || t || q));
        ...
        (o && (Pb(R, o, A, o + 'x'), v.timeScale(o)),
          100 === (k = ('inTime' in r ? Jb(r.inTime, i, 0, 0) : n ? t._inProgress : 0) || 0) &&
            !r.animation &&
            t &&
            (Vo(q), (k = Jb(r.inTime, i, 0, 0) || 0)),
          k && ((M.style.left = k + '%'), (M.style.display = D.style.display = 'block')),
          (S = ('outTime' in r ? Jb(r.outTime, i, 100, k) : n ? t._outProgress : 0) || 100) < k &&
            (S = 100),
          100 !== S && ((D.style.left = S + '%'), (M.style.display = D.style.display = 'block')),
          (d = 'loop' in r ? r.loop : _n('loop')) && So(!0),
          r.paused && v.progress(k / 100, !0).pause(),
          ae && i === q && se && r.globalSync && !P && v.time(-se, !0),
          H(!0));
      }
      var u,
        g,
        ...
        n = (function _createRootElement(e, t, o) {
          ...
          return (
            ...
            o &&
              ...
              n.style.width &&
                V.set(n, { xPercent: -50, left: '50%', right: 'auto', data: 'root' }).kill()),
            !t &&
              n.offsetWidth < 600 &&
        ...
        X = W.create(x, {
          ...
          onDrag: function onDrag() {
            ...
            (e < 0 ? (e = 0) : e > v._dur && (e = v._dur),
              h || v.time(e),
              (b.style.width = Math.min(S - k, Math.max(0, (e / v._dur) * 100 - k)) + '%'),
        ...
        Y = W.create(D, {
          ...
          onRelease: function onRelease() {
            (100 < S && (S = 100),
              ...
              (D.style.left = S + '%'),
              $n('out', S),
              V.set(D, { x: 0, data: 'root', display: 'block' }),
              m || (O(), v.resume()));
          },
        })[0],
        H = function updateProgress(e) {
          if (!X.isPressed || !0 === e) {
            ...
            (100 < o && (o = 100),
              S <= o
                ? !d || v.paused() || X.isDragging
                  ? ((o === S && -1 !== i._repeat) || ((o = S), v.progress(o / 100)),
                    !P && (S < 100 || 1 === i.totalProgress() || -1 === i._repeat) && I())
                  : n ||
                    ((o = k),
                    (t = v._targets && v._targets[0]) === i && t.seek(s + ((l - s) * k) / 100),
                    0 < i._repeat && !k && 100 === S
                      ? 1 === i.totalProgress() && v.totalProgress(0, !0).resume()
                      : v.progress(o / 100, !0).resume())
                : o < k && ((o = k), v.progress(o / 100, !0)),
              (o === T && !0 !== e) ||
                ((b.style.left = k + '%'),
                (b.style.width = Math.max(0, o - k) + '%'),
                (x.style.left = o + '%'),
        ...
        O = function play() {
          if (v.progress() >= S / 100) {
            Wb(v, r);
            var e = v._targets && v._targets[0];
            (e === i && e.seek(s + ((l - s) * k) / 100),
              v._repeat && !k ? v.totalProgress(0, !0) : v.reversed() || v.progress(k / 100, !0));
          }
      ...
      (Nb(C, 'change', Xo),
              ...
              Nb(
                ...
                (e = function keyboardHandler(e) {
                  ...
                  32 === o
                    ? F()
                    : 38 === o
                      ? ((t = parseFloat(Qb(R, -1, A))), v.timeScale(t), $n('timeScale', t))
                      : 40 === o
                        ? ((t = parseFloat(Qb(R, 1, A))), v.timeScale(t), $n('timeScale', t))
                        : 37 === o
                          ? Ro()
        ...
        (M._gsIgnore = D._gsIgnore = x._gsIgnore = t._gsIgnore = L._gsIgnore = !0),
        V.killTweensOf([M, D, x]),
        ep(ae),
          ...
          ee === p &&
            ...
            (function updateRootDuration() {
              ...
              i === q &&
                ...
                1e3 === (o = Math.min(1e3, q.duration())) && (o = Math.min(1e3, Hb(q))),
                1 != (t = J.duration() / o) &&
                  o &&
                  ((k *= t),
                  S < 100 && (S *= t),
