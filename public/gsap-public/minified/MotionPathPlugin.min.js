...
!(function (t, e) {
    ...
    if (c || r) {
      for (
        i = P < b || (L && M < R) || (T && m.t < d.t),
          y(a, b, R, d.t) &&
            (b++, i || (P++, T ? ((m.t = (m.t - d.t) / (1 - d.t)), (M = 0)) : L && (M -= R))),
          Math.abs(1 - (n - e)) < 1e-5
            ? (P = b - 1)
            : !m.t && P
              ? P--
  ...
  function getPositionOnPath(t, e, n, r) {
    ...
    return (
      ...
      (c.y = N(
        (u * u * (p[h + 7] - (g = p[h + 1])) + 3 * f * (u * (p[h + 5] - g) + f * (p[h + 3] - g))) *
          u +
          g
      )),
      n &&
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < x; e++)
      if (
        ...
        ((u = y),
          (g = w),
          ('C' !== p && 'S' !== p) || ((u += y - s[s.length - 4]), (g += w - s[s.length - 3])),
          i || (y = w = 0),
        ...
        if (
          ...
          (n = 7),
          1 < c.length &&
            (c.length < 3 ? ((g = u), (u = d), n--) : ((g = d), (u = c.substr(2)), (n -= 2)),
            (d = c.charAt(1)),
            (c = c.charAt(0))),
          (f = arcToSegment(
            y,
  ...
  function pointsToSegment(t, e) {
    ...
    for (
      R &&
        (t.push(w, x), (w = v), (x = y), (v = t[m - 2]), (y = t[m - 1]), t.unshift(v, y), (m += 4)),
        e = e || 0 === e ? +e : 1,
        a = 2;
      a < m;
      a += 2
      ...
      ((n = v),
        ...
        (v === w && y === x) ||
          ...
          (f =
            v -
            ((u = v - (v - n) * (s ? h / s : 0)) +
              ((((g = v + (w - v) * (l ? h / l : 0)) - u) * ((3 * s) / (s + l) + 0.5)) / 4 || 0))),
          (d =
            y -
            ((p = y - (y - r) * (s ? h / s : 0)) +
              ((((c = y + (x - y) * (l ? h / l : 0)) - p) * ((3 * s) / (s + l) + 0.5)) / 4 || 0))),
          (v === n && y === r) || P.push(N(u + f), N(p + d), N(v), N(y), N(g + f), N(c + d))));
    return (
      v !== w || y !== x || P.length < 4 ? P.push(N(w), N(x), N(w), N(x)) : (P.length -= 2),
    ...
    a = {
      ...
      init: function init(t, e, n) {
        ...
        if (
          ...
          (cacheRawPathMeasurements((r = p(nt(getRawPath(e.path), t, e))), e.resolution),
            o.push(r),
          ...
          for (a in (u && g
            ...
            : (u = g = 0),
          f))
            a !== u && a !== g && o.push(qa(this, na([], i, a, 2), t, a, 0, p, e, W(i[0][a])));
        }
