...
!(function (t, e) {
  ...
  function arcToSegment(t, e, n, i, s, a, o, r, h) {
    if (t !== r || e !== h) {
      ...
      for (B = 0; B < O.length; B += 2)
        ((_ = O[B]), (m = O[B + 1]), (O[B] = _ * q + m * V + E), (O[B + 1] = _ * z + m * j + M));
  ...
  function pointsToSegment(t, e) {
    ...
    for (
      S &&
        (t.push(y, P), (y = v), (P = b), (v = t[m - 2]), (b = t[m - 1]), t.unshift(v, b), (m += 4)),
        e = e || 0 === e ? +e : 1,
        a = 2;
      a < m;
      a += 2
      ...
      ((i = v),
        ...
        (v === y && b === P) ||
          ...
          (_ =
            b -
            ((g = b - (b - s) * (h ? c / h : 0)) +
              ((((f = b + (P - b) * (l ? c / l : 0)) - g) * ((3 * h) / (h + l) + 0.5)) / 4 || 0))),
          (v === i && b === s) || A.push(n(d + p), n(g + _), n(v), n(b), n(u + p), n(f + _))));
    return (
  ...
  function B(t) {
    ...
    if (((g = window), (b = new T()), e)) {
      ((f = (p = e).documentElement),
        (_ = e.body),
        ((y = p.createElementNS('http://www.w3.org/2000/svg', 'g')).style.transform = 'none'));
            ...
            -(s = (function _getCTM(t) {
              ...
              return (
                n ||
                  ...
                  e
                    ? (t.style[x] = e)
                    : t.style.removeProperty(x.replace(/([A-Z])/g, '-$1').toLowerCase())),
                n || b.clone()
              );
            })(t)).e / s.a),
          (o = -s.f / s.d),
  ...
  function Ma(t) {
    ...
    ((this._matrix = this.target.transform.baseVal.getItem(0).matrix),
      (this._ctm = s),
      O[t.type]
        ? ((e = -1 !== t.type.indexOf('touch') ? t.currentTarget || t.target : R),
  ...
  function Oa(t, e) {
    ...
    if (
      ...
      if (
        ...
        h ||
          (Ca(R, 'mouseup', n._onRelease), t && t.target && Ca(t.target, 'mouseup', n._onRelease)),
        o
          ? (n.isDragging = !1)
      ...
      (((q = DraggableSVG.prototype).setPointerPosition = function setPointerPosition(t, e) {
        ...
        ((this.pointerX = t),
          ...
          (this.x === s && this.y === a) ||
            ...
            !this.isDragging &&
              this.isPressed &&
              ((this.isDragging = !0), Ha('onDragStart', this, this.pointerEvent))));
      }),
    ...
    dt =
      ...
      (ct._onClickSelectionPath = function _onClickSelectionPath(t) {
        if ('hidden' === this._selection.style.visibility) this.select();
          ...
          for (
            ...
            this._anchors[i].i >= e && this._anchors[i].j === r.j && (this._anchors[i].i += 6);
      ...
      (ct._deleteSelectedAnchors = function _deleteSelectedAnchors() {
        for (var t, e, n, i, s = this._selectedAnchors, a = s.length; -1 < --a; )
          for (
            ...
            this._anchors[n].i >= e && this._anchors[n].j === i && (this._anchors[n].i -= 6);
        (this._updateAnchors(),
          this.update(),
          this._saveState(),
      ...
      (ct._updateAnchors = function _updateAnchors() {
        ...
        for (this._editingAnchor = i, t = 0; t < this._anchors.length; t++)
          this._anchors[t].element.style.fill =
            -1 !== this._selectedAnchors.indexOf(this._anchors[t]) ? V : 'white';
        (i &&
        ...
        for (s = 0; s < l; s++)
          ((i = (o = h[s]).i),
            ...
            i < a.length - 2 &&
              ...
              (a[i + 3] = (((a[i + 3] + n) * c) | 0) / c)),
            o !== t &&
              o.element.setAttribute('transform', 'translate(' + a[i] + it + a[i + 1] + ')'));
        this.update();
      }),
      ...
      (ct.getString = function getString(t, e, i) {
        if (t) {
          ...
          return (function rawPathToString(t) {
            ...
            for (i = 0; i < r; i++) {
              for (
                a = t[i], o += 'M' + n(a[0]) + ',' + n(a[1]) + ' C', e = a.length, s = 2;
                s < e;
                s++
              )
                o +=
      ...
      (ct.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
        var s,
          ...
          g = 1 / (c[p - 2] + d),
          f = -t || c[p - 1] + u;
        for (f = f ? 1 / f : -g, g *= 1e3, f *= 1e3, a = nt.length = 0; a < p; a += 2)
          ((nt[a] = (((c[a] + d) * g) | 0) / 1e3), (nt[a + 1] = (((c[a + 1] + u) * f) | 0) / 1e3));
        if (i) {
        ...
        return n && 8 === p && 0 === nt[0] && 0 === nt[1] && 1 === nt[p - 2] && 1 === nt[p - 1]
          ? nt.slice(2, 6).join(',')
  ...
  function PathEditor(t, e) {
    ((e = e || {}),
      ...
      (this._selection =
        e._selection || pa('g', this._g, { class: 'path-editor-selection path-editor' })),
  ...
  function MotionPathHelper(t, e) {
    ...
    (t instanceof ut.core.Tween
      ...
      c && !s && (s = jb(c.vars.motionPath.path || c.vars.motionPath, i, c.vars.motionPath)),
      ...
      (l = s && s.ownerSVGElement)
        ...
        : ((d =
            (a && i.ownerSVGElement && i.ownerSVGElement.getAttribute('xmlns')) ||
