...
!(function (e, t) {
    ...
    M = function _setDoc(e) {
      ...
      if (((f = window), (m = new ge()), t)) {
        ((i = (h = t).documentElement),
          (a = t.body),
          ((v = h.createElementNS('http://www.w3.org/2000/svg', 'g')).style.transform = 'none'));
  ...
  function Ka(e, t) {
    ...
    return Math.max(
      0,
      Qe(e) ? Math.max(ye[o], l[o]) - (me['inner' + n] || ye[r] || l[r]) : e[o] - e[r]
    );
  }
  function La(e, t) {
    var n = Ka(e, 'x'),
  ...
  function Pa(e) {
    if (e === me)
      return (
        (p.left = p.top = 0),
        (p.width = p.right = ye.clientWidth || e.innerWidth || l.clientWidth || 0),
        (p.height = p.bottom =
          ...
          (r &&
            ...
            (r && !e) ||
              ...
              (y = Math.max(0, i.scrollWidth - i.clientWidth)) &&
                (y += parseFloat(t.paddingLeft) + (R ? parseFloat(t.paddingRight) : 0))),
        ...
        return f || !n
          ...
          : ((i = -1 !== (n + '').indexOf('%')),
            ...
            !(o.width < 0 || o.height < 0) &&
              (i
                ? u * h * (n *= 0.01) <= (r = o.width * o.height) || r >= l.width * l.height * n
  ...
  function Draggable(h, p) {
      ...
      if (J.autoScroll && J.isDragging && (te || C)) {
        ...
        for (
          ...
          ((t = (n = Qe(c.parentNode)) ? We : c.parentNode),
            ...
            n &&
              (a || l) &&
              (me.scrollTo(t.scrollLeft, t.scrollTop), he(J.pointerX + a, J.pointerY + l)),
            (c = t));
      }
      if (C) {
        var p = J.x,
          ...
          : f
            ...
            : W
              ? (U && ((J.deltaY = u - parseFloat(se.y)), (se.y = u + 'px')),
                ...
                se.renderTransform(1, se))
              : (U && ((J.deltaY = u - parseFloat(h.style.top || 0)), (h.style.top = u + 'px')),
                K && ((J.deltaX = p - parseFloat(h.style.left || 0)), (h.style.left = p + 'px'))),
          !g ||
            e ||
            I ||
      ...
      (h._gsap || (se = xe.core.getCache(h)),
        ...
        (P || Y || N) &&
          ...
          (N &&
            ...
            n.y !== J.y && ((J.y = n.y), (C = !0))),
          P && (n = P(J.x)) !== J.x && ((J.x = n), Q && (J.rotation = n), (C = !0)),
          Y && ((n = Y(J.y)) !== J.y && (J.y = n), (C = !0))),
        C && Ah(!0),
        e || ((J.deltaX = J.x - r), (J.deltaY = J.y - i), Qa(J, 'throwupdate', 'onThrowUpdate')));
    }
    function Ch(a, l, s, n) {
      return (
        null == l && (l = -Be),
        ...
        p.liveSnap &&
          ...
          Q
            ...
            : n.points
              ? (N = (function buildPointSnapFunc(s, l, c, d, p, u, h) {
                  return (
                    ...
                    Z(s)
                      ...
                      : Ne(s)
                        ? function (e) {
                            for (var t, n, o, r, i = s.length, a = 0, l = Be; -1 < --i; )
              ...
              : (K && (P = Ch(o ? n : n.x || n.left || n.scrollLeft, S, D, f ? -1 : 1)),
                U && (Y = Ch(o ? n : n.y || n.top || n.scrollTop, A, X, f ? -1 : 1)))));
    }
    function Fh() {
    ...
    function Ih(e) {
      ...
      ((k = getGlobalMatrix(h.parentNode, !0)),
        e &&
          J.isPressed &&
          !k.equals(n || new ge()) &&
          ((t = n.inverse().apply({ x: w, y: b })), k.apply(t, t), (w = t.x), (b = t.y)),
        k.equals(r) && (k = null));
    }
    function Jh() {
      var e,
        ...
        r = ce ? Ga(de) : 0,
        i = ce ? Fa(de) : 0;
      (W && ((se.x = Sg(G, 'px') + 'px'), (se.y = Sg(V, 'px') + 'px'), se.renderTransform()),
        Ih(!1),
        (Ge.x = J.pointerX - r),
        (Ge.y = J.pointerY - i),
        k && k.apply(Ge, Ge),
    ...
    function Mh(e, t) {
      ...
      if (
        ...
        if (
          ...
          (O = null),
          (Ae && y) || (za(de, 'mouseup', fe), e && e.target && za(e.target, 'mouseup', fe)),
        ...
        if (
          ...
          (z = !R && !J.allowEventDefault) && (Ba(e), za(me, 'touchforcechange', Ba)),
          e.changedTouches
    ...
    function Qh(e) {
      if (e && J.isDragging && !f) {
        ...
        (n || o) &&
          (k ? ((w -= n * k.a + o * k.c), (b -= o * k.d + n * k.b)) : ((w -= n), (b -= o)),
          (t._gsScrollX += n),
          (t._gsScrollY += o),
    ...
    function Rh(e) {
      ...
      ((J.isPressed || o || n) && ((l && e.detail && n && !i) || Ba(e)),
        n || o || H || (e && e.target && (J.pointerEvent = e), Qa(J, 'click', 'onClick')));
    }
    function Sh(e) {
      return k
      ...
      ue = function onMove(e) {
        ...
        if (u && !De && J.isPressed && e) {
          ...
          (((i = Math.abs(n - w)) !== (a = Math.abs(o - b)) && (j < i || j < a)) ||
            ...
            ? fe(l)
            : ((z =
                J.allowEventDefault || (R && (!O || R === O)) || !1 === l.cancelable
                  ? z && !1
                  : (Ba(l), !0)),
              J.autoScroll && (te = !0),
        ...
        ((J.pointerX = e),
          ...
          Q
            ? ((a = Math.atan2(L.y - t, e - L.x) * ke),
              180 < (l = J.y - a) ? ((M -= 360), (J.y = a)) : l < -180 && ((M += 360), (J.y = a)),
              (i =
                J.x !== T || Math.max(Math.abs(w - e), Math.abs(b - t)) > j
                  ? ((J.y = a), T + (M - a) * c)
                  : T))
            : (k && ((s = e * k.a + t * k.c + k.e), (t = e * k.b + t * k.d + k.f), (e = s)),
              (r = t - b) < j && -j < r && (r = 0),
              (o = e - w) < j && -j < o && (o = 0),
              (J.lockAxis || J.lockedAxis) &&
                (o || r) &&
                ((s = J.lockedAxis) ||
                  ((J.lockedAxis = s = K && Math.abs(o) > Math.abs(r) ? 'y' : U ? 'x' : null),
                  s && Z(J.vars.onLockAxis) && J.vars.onLockAxis.call(J, J.pointerEvent)),
                'y' === s ? (r = 0) : 'x' === s && (o = 0)),
              (i = da(T + o * c)),
              (a = da(M + r * c))),
          (P || Y || N) &&
            ...
            Y && (a = da(Y(a)))),
          E &&
            (D < i ? (i = D + Math.round((i - D) * d)) : i < S && (i = S + Math.round((i - S) * d)),
            Q ||
              (X < a
          ...
          (J.x === i && (J.y === a || Q)) ||
            (Q
              ...
              : (U && ((J.y = J.endY = a), (C = !0)), K && ((J.x = J.endX = i), (C = !0))),
    ...
    return (
      ...
      (e.startDrag = function (e, t) {
        ...
        (Mh(e || J.pointerEvent, !0),
          t &&
            ...
            (w -= r.x - i.x),
            (b -= r.y - i.y)),
          J.isDragging || ((J.isDragging = H = !0), Qa(J, 'dragstart', 'onDragStart')));
      }),
      (e.drag = ue),
      ...
      (e.update = function (e, t, n) {
        ...
        return (
          ...
          J.isPressed &&
            !t &&
            ((K && 0.01 < Math.abs(a - J.x)) || (U && 0.01 < Math.abs(l - J.y) && !Q)) &&
            Jh(),
          J.autoScroll &&
            (La(h.parentNode, J.isDragging), (te = J.isDragging), Ah(!0), Ia(h, Qh), Ha(h, Qh)),
          J
        );
      }),
      (e.enable = function (e) {
        ...
        return (
          Ha(h, Qh),
          (u = !0),
          _e && 'soft' !== e && _e.track(f || h, W ? 'x,y' : Q ? 'rotation' : 'top,left'),
