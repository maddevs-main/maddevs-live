...
(function (B, A) {
  ...
  let A,
    ...
    P = e =>
      typeof e == 'string' ? P(document.querySelectorAll(e)) : 'length' in e ? Array.from(e) : [e],
...
` &&
              ...
              (u < m.length || d) &&
                z(u >= m.length ? ' ' : r && p.slice(-1) === ' ' ? ' ' + f : f, e, l);
            }
          (e.removeChild(l), (E = 0));
        } else
          l.nodeType === 1 &&
                ...
                ((F = O[d]),
                  F.nodeType === 1 &&
                    (F.nodeName === 'BR'
                      ...
                      : (d && k[d].top > N.top && k[d].left <= N.left && (T(p, d), (p = d)),
                        (N = k[d]))));
              (p < d && T(p, d),
                w.forEach(M => {
                  var le;
              ...
              for (d = 0; d < l.length; d++)
                if (((u = l[d]), g || !u.nextSibling || u.nextSibling.nodeType !== 3))
                  ...
                  ((S = u.nextSibling),
                    S &&
                      S.nodeType === 3 &&
                      ((S.textContent = (u.textContent || '') + (S.textContent || '')),
                      u.remove()));
