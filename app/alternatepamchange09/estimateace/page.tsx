    ...
    <>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20, marginBottom: 32 }}>
          <a
            href="/alternatepamchange09/estimateace/manage/onboard"
            style={{ fontSize: 20, color: '#0074d9', textDecoration: 'underline', marginBottom: 8 }}
          >
            Onboard Management
          </a>
          <a
            href="/alternatepamchange09/estimateace/manage/blogs"
            style={{ fontSize: 20, color: '#0074d9', textDecoration: 'underline', marginBottom: 8 }}
          >
            Blogs Management
          </a>
          <a
            href="/alternatepamchange09/estimateace/manage/news"
            style={{ fontSize: 20, color: '#0074d9', textDecoration: 'underline', marginBottom: 8 }}
          >
            News Management
          </a>
