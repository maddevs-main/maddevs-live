      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage', // TODO: Use a more specific type if possible
            'name': 'WORKS PAGE TITLE HERE', // TODO: Match this to the title above
            // ...add more fields as needed
          }),
        }}
      />
      <div className="sr-only">Portfolio: web development projects, UX/UI design, SaaS, AI, digital transformation</div>
      <style>{`
        body, html { margin: 0; padding: 0; width: 100%; height: 100%; overflow: hidden; background-color: #000; }
        body { font-family: cursor:'none', Inter', sans-serif; color: #f0f0f0; }
        body::after { content: ""; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-image: url("https://png.pngtree.com/thumb_back/fh260/background/20231014/pngtree-computer-motherboard-parts-perfect-for-backgrounds-or-textures-image_13617874.png?w=640"); opacity: 0.25; mix-blend-mode: screen; pointer-events: none; z-index: 1; }
