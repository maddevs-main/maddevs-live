...
const blogsData = {
  ...
  '@type': 'Organisation',
  name: 'blogs/maddevs – creative web design & development',
  description:
    'Explore our blog for insights on web development, design trends, technical tutorials, and industry best practices. From frontend frameworks and backend architecture to UI/UX design principles and emerging technologies.',
  ...
  blogPost: [
    {
      ...
      description:
        'Essential best practices for modern web development including performance optimization, security, and user experience.',
      author: { '@type': 'Organization', name: 'maddevs' },
      category: 'Web Development'
    },
    {
      '@type': 'BlogPosting',
      headline: 'Design Trends and Principles',
      description:
        'Latest design trends and fundamental principles for creating engaging and effective user interfaces.',
      author: { '@type': 'Organization', name: 'maddevs' },
      category: 'Design'
    },
    {
      '@type': 'BlogPosting',
      headline: 'Technical Tutorials and Guides',
      description:
        'Step-by-step tutorials and comprehensive guides for various web technologies and frameworks.',
      author: { '@type': 'Organization', name: 'maddevs' },
      category: 'Tutorials'
    },
    {
      '@type': 'BlogPosting',
      headline: 'Industry Insights and Analysis',
      description:
        'In-depth analysis of industry trends, technology adoption, and strategic insights for digital businesses.',
      author: { '@type': 'Organization', name: 'maddevs' },
      category: 'Industry'
    }
  ]
...
const BlogCard = ({
  ...
  // Use the specific placeholder image URL for blogs
  const placeholderImageUrl = 'https://placehold.co/600x400/E6DACE/282222?text=Ancient+Art+5';

  // Get the appropriate image URL
  const imageUrl = isValidImageUrl(blog.imageUrl)
    ? blog.imageUrl
    : placeholderImageUrl;
    ...
    return (
      ...
      >
        <div className="col-span-1">
          <img
            src={imageUrl}
            alt={`Web development and design blog image: ${blog.title}`}
...
const BlogListPage = ({
  ...
  const allTags = Array.from(
    new Set(blogs.flatMap(b => (b.tags ?? []).map(t => t.charAt(0).toUpperCase() + t.slice(1))))
  );
  const filteredBlogs =
    activeTag === 'All'
      ? allBlogs
      : allBlogs.filter(blog =>
        (blog.tags ?? []).map(t => t.toLowerCase()).includes(activeTag.toLowerCase())
      );
  useEffect(() => {
        ...
        <aside className="lg:col-span-1 order-1 lg:order-2">
          <div className="sticky top-12">
            <div className="bg-[#393E46] p-6">
              <h3 className="font-semibold text-[white] mb-4 border-b border-[#A0A0A0] pb-2">
                {' '}
                pinned
              </h3>
    ...
    return (
      <div className="bg-[white] min-h-screen flex flex-col items-center justify-center font-mono">
        ...
        <button
          ...
          className="text-[#474242] hover:text-[#000000] underline mt-4"
        >
      ...
      <header className="flex justify-between items-start mb-8 md:mb-12">
        <div>
          <button
            ...
            className="text-base text-[#C0BDBD] hover:text-[#FFFFFF] mb-4 block hover:underline"
          >
            blogs/
          </button>
  ...
  return (
    <>
      ...
      <div className="sr-only">
        Blogs: web development, user experience, SaaS, AI, digital product insights
      </div>
      <Script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(blogsData) }}
      />
