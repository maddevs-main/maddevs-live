...
const onboardData = {
  ...
  '@type': 'Service',
  name: 'onboard/maddevs – creative web design & development',
  description:
  ...
  serviceType: 'Digital Project Onboarding',
  areaServed: {
    '@type': 'Country',
    name: 'Worldwide'
  },
  hasOfferCatalog: {
    '@type': 'OfferCatalog',
    name: 'Onboarding & Consultation Services',
    itemListElement: [
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          description:
            'A virtual consultation to understand your goals, audience, and project landscape—setting the foundation for a tailored system.'
        }
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          description:
            'Strategically map requirements, user flows, and system components. Define what’s needed, why, and how it works together.'
        }
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          description:
            'Evaluate tech stack options and system architecture aligned with your business needs, scalability goals, and timeline.'
        }
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          description:
            'Develop a realistic timeline, priority matrix, and phased approach for your digital product.'
        }
      }
    ]
  }
...
export default function OnboardPage() {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus({ submitted: true, submitting: false, info: { error: false, msg: '' } });
      if (!formWrapperRef.current) return;
      gsap.to(formWrapperRef.current, {
        duration: 0.6,
        xPercent: 100,
      ...
      setStatus({
        submitted: false,
        submitting: false,
        info: { error: true, msg: (error as Error).message || 'Something went wrong.' },
      });
    }
  };
  ...
  const CustomDatePicker = ({
      ...
      for (let day = 1; day <= daysInMonth; day++) {
        ...
        days.push(
          <button
            ...
            disabled={isDisabled}
            onClick={() => {
              onChange({ target: { name: 'date', value: date.toISOString().split('T')[0] } });
              setShowDatePicker(false);
            }}
            className={`p-2 w-full text-center text-sm font-mono rounded-none transition-colors duration-200 ${isDisabled ? 'text-gray-700 cursor-not-allowed' : 'text-gray-400 hover:bg-gray-600'} ${isSelected ? 'bg-gray-300 text-[#241b1b] font-bold' : ''}`}
          >
            {day}
          </button>
        );
    ...
    return (
      <div className="relative" ref={datePickerRef}>
        ...
        {showDatePicker && (
          <div className="absolute top-full left-0 mt-2 w-full bg-gray-800/80 backdrop-blur-sm border border-gray-600 p-4 z-10">
            ...
            <div className="grid grid-cols-7 gap-1 text-center text-xs text-gray-500 font-mono mb-2">
  ...
  const inputClasses =
    'w-full bg-[transparent] border border-gray-600 text-gray-300 font-mono p-2 rounded-none focus:outline-none focus:border-gray-400 transition-colors duration-300 text-sm';
  const timePresetClasses = (isSelected: boolean) =>
    `border font-mono uppercase tracking-wider text-xs rounded-none px-4 py-2 transition-all duration-300 ${isSelected ? 'bg-gray-300 text-gray-800' : 'border-gray-600 text-gray-400 hover:bg-gray-500 hover:text-gray-300'}`;
  ...
  return (
    <>
      ...
      <div
        ref={pageWrapperRef}
        className="bg-[#241b1b] min-h-screen w-full flex flex-col justify-center font-sans text-gray-300 overflow-x-hidden"
        ...
        <div className="w-full mt-20">
          ...
          <Script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify(onboardData),
            }}
          />
          <h1
            ref={onboardRef}
            className="text-[19vw] sm:text-[18vw] md:text-[20vw] lg:text-[22vw] font-black text-gray-700 tracking-tighter lowercase relative text-right"
            style={{ right: '-2vw' }}
          ></h1>
          <br></br>
          <div
            ref={contentParaRef}
            className="w-full -mt-2 sm:-mt-4 md:-mt-6 lg:-mt-8 pl-4 sm:pl-6 lg:pl-8"
          >
            <p className="font-mono text-sm sm:text-base max-w-2xl">
              A consultancy, creative studio, tech agency, or a software company, call as you may. Our onboarding process is simple, fast and very smooth. We start with a virtual
              meetup, where we dive deep into your project, your goals, your vision—what your dream,
              your idea feels like, to you and to us. A handshake, and that's it.
            </p>
          ...
          <div className="w-full mt-8 md:mt-12 flex justify-end" style={{ paddingBottom: '3rem' }}>
            <div
              ref={formWrapperRef}
              className="bg-gray-700/50 backdrop-blur-sm p-6 sm:p-8 w-full max-w-md"
            >
              <div className="relative" style={{ minHeight: '450px' }}>
                {/* Step 1: Initial Details */}
                {step === 1 && (
                  <div className="w-full">
                    <p className="font-mono text-xs sm:text-sm text-left mb-6 text-gray-300">
                    ...
                    <form className="w-full text-left" onSubmit={e => e.preventDefault()}>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="sm:col-span-1">
                          <label
                            htmlFor="name"
                            className="block text-xs font-mono uppercase tracking-wider text-gray-300 mb-1"
                          >
                            Full Name
                          </label>
                          <input
                      ...
                      <div className="mt-6 flex justify-end">
                        <button
                          ...
                          className="font-mono uppercase tracking-wider text-gray-300 border border-gray-500 px-6 py-2 text-sm rounded-none hover:bg-gray-300 hover:text-[#241b1b] transition-all duration-300"
                        >
                          Next
                        </button>
                      </div>
                    ...
                    <form className="space-y-6" onSubmit={handleFormSubmit}>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                          {timePresets.map(time => (
                            <button
                              ...
                              className={timePresetClasses(formData.time === time)}
                            >
                              {time}
                            </button>
                          ))}
                        ...
                        <div className="mt-4">
                          ...
                          <input
                            ...
                            value={formData.time}
                            onChange={handleInputChange}
                            className={`${inputClasses} custom-time-picker`}
                          />
                        </div>
                      </div>
                      <div className="pt-2 flex justify-end">
                        <button
                          ...
                          className="font-mono uppercase tracking-wider text-gray-300 border border-gray-500 px-6 py-2 text-sm rounded-none hover:bg-gray-300 hover:text-[#241b1b] transition-all duration-300 disabled:opacity-50"
                        >
                ...
                {step === 3 && (
                  ...
                  >
                    <div className="text-left p-6 sm:p-8 border border-gray-600 w-full">
                      <h3 className="font-mono text-lg text-gray-300">
                      ...
                      <p className="font-mono text-sm text-gray-400 mt-1">
                        Once confirmed, the meeting details will be sent to your email.
                      </p>
                      ...
                      <div className="font-mono text-sm space-y-2 text-gray-300">
                        <p>
                          <strong>ID:</strong>
                          <span className="text-gray-400 ml-2">{meetingId}</span>
                        </p>
                        <p>
                          <strong>Organisation:</strong>
                          <span className="text-gray-400 ml-2">{formData.organisation}</span>
                        </p>
                        <p>
                          <strong>Email:</strong>
                          <span className="text-gray-400 ml-2">{formData.email}</span>
                        </p>
                        <p>
                          <strong>Project:</strong>
                          <span className="text-gray-400 ml-2">{formData.title}</span>
                        </p>
                        <p>
