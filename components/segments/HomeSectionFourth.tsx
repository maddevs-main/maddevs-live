...
export default function CreativeSection() {
    ...
    const triggerGlitch = useCallback((targetWord) => {
    ...
    return (
        ...
        <div className="subsection min-h-screen w-full flex flex-col justify-between bg-[#948979] text-[#222222] overflow-hidden font-mono">
            ...
            <div className="flex flex-col mt-0 w-full">
                 <h2 className="text-4xl sm:text-6xl md:text-7xl font-normal border-t-1 border-[#222222] py-4 px-6 sm:px-8">intent</h2>
                 <h2 className="text-4xl sm:text-6xl md:text-7xl font-normal border-t-2 border-[#222222] py-4 px-6 sm:px-8">desire</h2>
                 <h2 className="text-4xl sm:text-6xl md:text-7xl font-normal border-t-2 border-b-2 border-[#222222] py-4 px-6 sm:px-8">objective</h2>
            </div>
            ...
            <div>
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-light mt-4 px-6 sm:px-8">simple, but significant.</h2>
            </div>
        </div>
    );
};
